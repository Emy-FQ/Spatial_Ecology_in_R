...
This script installs and loads the **igraph** package, defines species and their predator–prey interactions, constructs a directed ecological network, visualizes it, and prints basic statistics.
